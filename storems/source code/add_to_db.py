...
class Database:
    ...
    def get_items(self, *args, **kwargs):
        ...
        if self.name=="" or self.stock=="" or self.cp=="" or self.sp=="":
            tkinter.messagebox.showinfo("Error", "Please fill the fields")
        else:
            sql= "INSERT INTO inventory(name,stock,cp,sp,totalcp,totalsp,assumed_profit, vendor, vendorphoneno) VALUES(?,?,?,?,?,?,?,?,?)"
